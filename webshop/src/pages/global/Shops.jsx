...
function Shops() {
  ...
  return (<div>
    <Button onClick={() => setCoordinates({lngLat: [58.8281, 25.7803], zoom: 7})}>Kõik poed</Button>
    <Button onClick={() => setCoordinates({lngLat: [59.4378, 24.7574], zoom: 11})}>Kõik Tallinna poed</Button>
    {/* <Button onClick={() => setCoordinates({lngLat: [59.4220, 24.7938], zoom: 13})}>Ülemiste</Button>
